...
var require_evaluate = __commonJS({
  "api/demo/evaluate.js"(exports, module) {
    var { evaluateIntent } = require_governance_evaluate();
...
// tmp/pages-function-entries/api__demo__evaluate.js
var handlerModule = __toESM(require_evaluate());
