...
// api/_lib/notify-discord.js
var require_notify_discord = __commonJS({
  "api/_lib/notify-discord.js"(exports, module) {
    var { isTestIntake, testPipelineLabel } = require_intake_test();
    var DEDUP_TTL_MS = 24 * 60 * 60 * 1e3;
    var SEND_TIMEOUT_MS = 5e3;
    var COLOR_LEAD = 13216098;
    var COLOR_TEST = 7041664;
    var ALLOWED_WEBHOOK_HOSTS = /* @__PURE__ */ new Set(["discord.com", "discordapp.com", "ptb.discord.com", "canary.discord.com"]);
    var _notifiedIntakeIds = /* @__PURE__ */ new Map();
    var _notifiedRequestIds = /* @__PURE__ */ new Map();
    function webhookUrl() {
    ...
    function formatIntakeEmbed(body, intakeId) {
      ...
      return {
        title: isTest ? "Test intake \xB7 " + clip(testPipelineLabel(body), 200) : "New intake",
...
var require_intake = __commonJS({
  "api/intake.js"(exports, module) {
    ...
    var { sendIntakeDiscord, discordConfigured, discordPathOk } = require_notify_discord();
    ...
    module.exports = async function handler2(req, res) {
      ...
      try {
        discordResult = await sendIntakeDiscord(body, intakeId, { deduped });
      } catch (err) {
