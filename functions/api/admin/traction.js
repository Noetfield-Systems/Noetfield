...
// api/admin/traction.js
var require_traction = __commonJS({
  "api/admin/traction.js"(exports, module) {
    function cors(res) {
...
// tmp/pages-function-entries/api__admin__traction.js
var handlerModule = __toESM(require_traction());
