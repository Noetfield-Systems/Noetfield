...
// api/_lib/product-job-proxy.js
var require_product_job_proxy = __commonJS({
  "api/_lib/product-job-proxy.js"(exports, module) {
...
// api/product/jobs/result.js
var require_result = __commonJS({
  "api/product/jobs/result.js"(exports, module) {
    var { forwardPlatform } = require_product_job_proxy();
    module.exports = async function handler2(req, res) {
      ...
      return forwardPlatform(req, res, {
        method: "GET",
        path: `/api/product/jobs/${encodeURIComponent(jobId)}/result`
      });
    };
  }
});
...
// tmp/pages-function-entries/api__product__jobs__result.js
var handlerModule = __toESM(require_result());
