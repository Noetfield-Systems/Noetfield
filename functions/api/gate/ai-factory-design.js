...
// api/gate/ai-factory-design.js
var require_ai_factory_design = __commonJS({
  "api/gate/ai-factory-design.js"(exports, module) {
    var { buildFactoryReceipt, validateGateRequest } = require_ai_factory_core();
