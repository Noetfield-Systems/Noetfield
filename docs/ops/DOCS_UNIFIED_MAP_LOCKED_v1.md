...
| **Enforcement map** | `docs/ops/AGENTIC_ENFORCEMENT_MAP_LOCKED_v1.md` | Eval→enforce chain, R-012/R-013 |
| **Agent events** | `.cursor/events/REGISTRY.md` | Session/gate audit trail (SKILL-010) |
