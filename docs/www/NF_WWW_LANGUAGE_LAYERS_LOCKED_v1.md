...
**Strategy:** Client-facing first. Internal factory (ASF, W3 and operating internals) stays in repo/docs/ops. NF-WEB-001 permits a status-labeled SourceA portfolio/case-study reference on the corporate surface, never internal process exposition.
