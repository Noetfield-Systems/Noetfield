...
def test_homepage_explains_company_portfolio_proof_and_asks() -> None:
    ...
    required = (
        ...
        "Noetfield builds AI Motors: governed execution vehicles",
        "like a Tesla-class car",
        "Engines think. Models generate. Agents participate. Motors operate.",
        "Tesla-class vehicle: turns intent into action and work",
        "Custom AI Motors",
