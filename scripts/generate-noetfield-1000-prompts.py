...
PHASE_TASKS: list[list[str]] = [
    [  # phase-0 ship-ops
        ...
        "Grep www copy for competitor names — reject",
    ...
    [  # phase-3 workspace-enterprise
        ...
        "Compare ServiceNow evidence workflow to 5-min TLE path (doc)",
    ...
    [  # phase-4 agents-automation
        ...
        "Compare MindBridge verifiable surface to /status-system pattern",
    ...
    [  # phase-7 pilot-gtm
        ...
        "Compare Kwick-style table pattern without competitor names",
...
GLOBAL_SOURCES = [
    ...
    {"doc_id": "governance-sources", "path": "docs/reference/GOVERNANCE_SOURCES_BOOK_v1.md", "optional": False},
    {"doc_id": "drift-sources", "path": "docs/reference/GOVERNANCE_DRIFT_DETECTION_SOURCES_v1.md", "optional": False},
