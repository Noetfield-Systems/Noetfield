...
SHIP_DONE_MAP: dict[str, list[int]] = {
    ...
    "ship-v16-packaging-www-057": [8, 28, 48, 68, 88],
    "ship-v16-prompt-pack-058": [8, 28, 48, 68, 88],
    "ship-v16-verify-e2e-059": [8, 28, 48, 68, 88],
    "ship-pricing-verify-doc-ssot-059": [8, 28, 48, 68, 88],
    "ship-portfolio-np1-pricing-align-060": [8, 28, 48, 68, 88],
    "ship-portfolio-np1-funnel-metrics-061": [8, 28, 48, 68, 88],
    "ship-portfolio-np1-hub-intake-062": [8, 28, 48, 68, 88],
    "ship-portfolio-np3-wave-complete-063": [8, 28, 48, 68, 88],
    "ship-portfolio-np3-cu-intake-064": [8, 28, 48, 68, 88],
    "ship-portfolio-np3-boundary-faq-065": [8, 28, 48, 68, 88],
    "ship-portfolio-np4-msp-flow-066": [8, 28, 48, 68, 88],
    "ship-portfolio-np4-gel-tiers-067": [8, 28, 48, 68, 88],
    "ship-portfolio-np4-ffiec-068": [8, 28, 48, 68, 88],
    "ship-portfolio-np5-runtime-api-069": [8, 28, 48, 68, 88],
    "ship-portfolio-np5-template-catalog-070": [8, 28, 48, 68, 88],
    "ship-portfolio-np5-sdk-scaffold-071": [8, 28, 48, 68, 88],
    "ship-portfolio-np6-live-proof-072": [8, 28, 48, 68, 88],
    "ship-portfolio-np6-investor-vault-073": [8, 28, 48, 68, 88],
    "ship-portfolio-np6-battlecards-074": [8, 28, 48, 68, 88],
    "ship-portfolio-np7-osfi-refresh-075": [8, 28, 48, 68, 88],
    "ship-portfolio-np7-metadata-index-076": [8, 28, 48, 68, 88],
