...
check_html "${BASE}/copilot/" "copilot hub" "audit trail your Copilot deployment" "5-minute demo" "Copilot governance metrics" "Governance execution pipeline" "Registry vs receipt"
