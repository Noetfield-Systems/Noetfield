...
check_html "${BASE}/copilot/demo/" "copilot demo" "Full async demo" "Demo script (locked narrative)" "confidence score" "without a sales call"
...
check_html "${BASE}/enterprise/" "enterprise page" "OSFI E-23" "Governance execution pipeline" "not RPAA retail payments" "Request Governance Brief" "Starter" "Sandbox" "Production"
