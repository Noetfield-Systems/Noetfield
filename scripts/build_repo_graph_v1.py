...
_EXCLUDED_TOP = {
    ".cache", ".git", ".next", ".pytest_cache",
    ".turbo", ".venv", ".vercel", ".wrangler",
    "__pycache__", "_archive", "build", "dist",
    "graph-out", "node_modules", "noetfield.egg-info", "tmp",
    "var", "vendor", "venv", "www-pages-dist",
}
