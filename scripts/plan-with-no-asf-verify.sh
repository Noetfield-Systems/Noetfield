...
chmod +x scripts/verify-ui-endpoints.sh scripts/verify-ui-e2e.sh scripts/verify-ui-visual-e2e.sh scripts/verify-copilot-demo-links.sh
...
./scripts/verify-ui-visual-e2e.sh
