...
| Check | Status |
|-------|--------|
| Total prompts | 1000 / 1000 |
| Pre-marked done (shipped waves) | 12 |
| Backlog | 988 |
| T0 backlog (pick script) | 238 |
...
- [optional] `~/Desktop/SourceA/CURSOR_AGENT_CONTEXT_MEMORY_INCIDENT_LOCKED_v1.md` — OK
- [optional] `ops/private/agent-reference/REPO_TRUTH_CORRECTIONS.md` — OK
- [optional] `ops/private/todolist/NEXT_MOVES.md` — OK
