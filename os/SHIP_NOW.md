...
**Packaging v16 (2026-06-13):** Self-serve sandbox shipped — `/start/` · `/pricing/` · agentic workflows · [WWW_V16_PACKAGING_PLAN_LOCKED_v1.md](docs/WWW_V16_PACKAGING_PLAN_LOCKED_v1.md).

**Cloud GTM iter 19:** see [GTM_NEXT.md](docs/ops/plans/no-asf/GTM_NEXT.md) (server-side sandbox optional, agentic manifest wire, doc-ssot guards).
